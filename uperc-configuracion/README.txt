...
a persistence unit "uperc-configuracionPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "uperc-configuracion\pom.xml":
...
artifact ("uperc-configuracion.war") is already built. You can build
