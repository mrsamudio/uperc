...
a persistence unit "uperc-reservasPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "uperc-reservas\pom.xml":
...
artifact ("uperc-reservas.war") is already built. You can build
