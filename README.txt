...
a persistence unit "upercPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "uperc\pom.xml":
...
artifacts ("uperc-ejb.jar" and "uperc-web.war") are already built. You can build
