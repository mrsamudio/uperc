...
a persistence unit "uperc-recursosPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "uperc-recursos\pom.xml":
...
artifact ("uperc-recursos.war") is already built. You can build
