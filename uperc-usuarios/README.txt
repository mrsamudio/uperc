...
a persistence unit "uperc-usuariosPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "uperc-usuarios\pom.xml":
...
artifact ("uperc-usuarios.war") is already built. You can build
