...
class CRUDTest {
	...
	// TODO: insertar info en Log AOP
		...
		private static Usuario usuarioInsert = new Usuario("nombre", "apellidos", 'E', "77225302292021", "mi contraseña", "info43@ucundinamarca.edu.co",
				Date.valueOf("1999-10-04"), Timestamp.from(Instant.now()), false, rol);

		private static Usuario usuarioUpdate = new Usuario((long) 2, "Ad", "Ministro", 'C', "00000001", "minijtro", "minijtro@localhost",
				Date.valueOf("2021-02-16"), Timestamp.valueOf("2021-02-16 11:14:55.808771"), true, rol);
		...
		void insert() {
			...
			assertEquals(true, test, "Inserción a bd, no se obtuvo el resultado esperado en " + CRUDTest.class.getSimpleName());
		}
		...
		void deleteInsert() {
			...
			assertEquals(true, prueba, "insert rollback a bd, no se obtuvo el resultado esperado en " + CRUDTest.class.getSimpleName());
		}
		...
		void update() {
			...
			assertAll("En actualización del usuario.", () -> assertNotNull(getUsuarioUpdate()), () -> assertNotNull(usuarioEsperado),
		...
		void deactivate() {
			...
			assertAll("En desactivación del usuario", () -> assertNotNull(getUsuarioUpdate()), () -> assertNotNull(usuarioEsperado),
					() -> assertEquals(true, prueba, "Consulta a bd, no se obtuvo el resultado esperado."),
